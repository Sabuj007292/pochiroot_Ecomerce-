...
//     const [mobile, setNobile] = useState("");
...
//                                         id="mobile"
//                                         type="text"
//                                         placeholder="8240919580"
//                                         value={mobile}
//                                         onChange={(e) => setNobile(e.target.value)}
//                                         required
//                                         className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all outline-none"
//                                     />
//                                 </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <LocateIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                  <input
                    id="address"
                    type="text"
